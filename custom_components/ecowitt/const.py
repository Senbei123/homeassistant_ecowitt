...
SENSOR_TYPES = {
    ...
    TYPE_WH80BATT: ("Ecowitt WH80 Battery", ELECTRIC_POTENTIAL_VOLT, TYPE_SENSOR,
                    DEVICE_CLASS_BATTERY, "mdi:battery", 0),
    TYPE_SOILBATT1: ("Ecowitt Soil Moisture 1 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT2: ("Ecowitt Soil Moisture 2 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT3: ("Ecowitt Soil Moisture 3 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT4: ("Ecowitt Soil Moisture 4 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT5: ("Ecowitt Soil Moisture 5 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT6: ("Ecowitt Soil Moisture 6 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT7: ("Ecowitt Soil Moisture 7 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_SOILBATT8: ("Ecowitt Soil Moisture 8 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    ...
    TYPE_LEAKBATT8: ("Ecowitt Leak 8 Battery", PERCENTAGE, TYPE_SENSOR,
                     DEVICE_CLASS_BATTERY, "mdi:battery", 0),
    TYPE_WN34TEMP1C: ("Ecowitt Soil Temperature 1", TEMP_CELSIUS,
                      TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE,
                      "mdi:thermometer", 0),
    TYPE_WN34TEMP2C: ("Ecowitt Soil Temperature 2", TEMP_CELSIUS,
                      TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE,
                      "mdi:thermometer", 0),
    TYPE_WN34TEMP3C: ("Ecowitt Soil Temperature 3", TEMP_CELSIUS,
                      TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE,
                      "mdi:thermometer", 0),
    TYPE_WN34TEMP4C: ("Ecowitt Soil Temperature 4", TEMP_CELSIUS,
                      TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE,
                      "mdi:thermometer", 0),
    TYPE_WN34TEMP5C: ("Ecowitt Soil Temperature 5", TEMP_CELSIUS,
                      TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE,
                      "mdi:thermometer", 0),
    TYPE_WN34TEMP6C: ("Ecowitt Soil Temperature 6", TEMP_CELSIUS,
                      TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE,
                      "mdi:thermometer", 0),
    TYPE_WN34TEMP7C: ("Ecowitt Soil Temperature 7", TEMP_CELSIUS,
                      TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE,
                      "mdi:thermometer", 0),
    TYPE_WN34TEMP8C: ("Ecowitt Soil Temperature 8", TEMP_CELSIUS,
                      TYPE_SENSOR, DEVICE_CLASS_TEMPERATURE,
                      "mdi:thermometer", 0),
    TYPE_WN34BATT1: ("Ecowitt Soil Temperature 1 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE,
                     "mdi:battery", 0),
    TYPE_WN34BATT2: ("Ecowitt Soil Temperature 2 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE,
                     "mdi:battery", 0),
    TYPE_WN34BATT3: ("Ecowitt Soil Temperature 3 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE,
                     "mdi:battery", 0),
    TYPE_WN34BATT4: ("Ecowitt Soil Temperature 4 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE,
                     "mdi:battery", 0),
    TYPE_WN34BATT5: ("Ecowitt Soil Temperature 5 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE,
                     "mdi:battery", 0),
    TYPE_WN34BATT6: ("Ecowitt Soil Temperature 6 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE,
                     "mdi:battery", 0),
    TYPE_WN34BATT7: ("Ecowitt Soil Temperature 7 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE,
                     "mdi:battery", 0),
    TYPE_WN34BATT8: ("Ecowitt Soil Temperature 8 Battery", ELECTRIC_POTENTIAL_VOLT,
                     TYPE_SENSOR, DEVICE_CLASS_VOLTAGE,
                     "mdi:battery", 0),
    TYPE_WH90BATT_PC: ("Ecowitt WH90 Battery Percentage", None, TYPE_SENSOR,
                       DEVICE_CLASS_BATTERY, "mdi:battery", 0),
    TYPE_WH90BATT: ("Ecowitt WH90 Battery", ELECTRIC_POTENTIAL_VOLT, TYPE_SENSOR,
                    DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_WH90CAP_VOLT: ("Ecowitt WH90 Capacitor", ELECTRIC_POTENTIAL_VOLT, TYPE_SENSOR,
                        DEVICE_CLASS_VOLTAGE, "mdi:battery", 0),
    TYPE_RAINRATE_PIEZO_IN: ("Ecowitt Rain Rate Piezo", f"{LENGTH_INCHES}/{TIME_HOURS}",
                             TYPE_SENSOR, None, "mdi:water", S_IMPERIAL),
    TYPE_EVENTRAIN_PIEZO_IN: ("Ecowitt Event Rain Rate Piezo", f"{LENGTH_INCHES}/{TIME_HOURS}",
                              TYPE_SENSOR, None, "mdi:water", S_IMPERIAL),
    TYPE_HOURLYRAIN_PIEZO_IN: ("Ecowitt Hourly Rain Rate Piezo", f"{LENGTH_INCHES}/{TIME_HOURS}",
                               TYPE_SENSOR, None, "mdi:water", S_IMPERIAL),
    TYPE_DAILYRAIN_PIEZO_IN: ("Ecowitt Daily Rain Rate Piezo", f"{LENGTH_INCHES}/{TIME_DAYS}",
                              TYPE_SENSOR, None, "mdi:water", S_IMPERIAL),
    TYPE_WEEKLYRAIN_PIEZO_IN: ("Ecowitt Weekly Rain Rate Piezo", f"{LENGTH_INCHES}/{TIME_WEEKS}",
                               TYPE_SENSOR, None, "mdi:water", S_IMPERIAL),
    TYPE_MONTHLYRAIN_PIEZO_IN: ("Ecowitt Monthly Rain Rate Piezo", f"{LENGTH_INCHES}/{TIME_MONTHS}",
                                TYPE_SENSOR, None, "mdi:water", S_IMPERIAL),
    TYPE_YEARLYRAIN_PIEZO_IN: ("Ecowitt Yearly Rain Rate Piezo", f"{LENGTH_INCHES}/{TIME_YEARS}",
                               TYPE_SENSOR, None, "mdi:water", S_IMPERIAL),
    TYPE_RAINRATE_PIEZO_MM: ("Ecowitt Rain Rate Piezo", f"mm/{TIME_HOURS}",
                             TYPE_SENSOR, None, "mdi:water", S_METRIC),
    TYPE_EVENTRAIN_PIEZO_MM: ("Ecowitt Event Rain Rate Piezo", f"mm/{TIME_HOURS}",
                              TYPE_SENSOR, None, "mdi:water", S_METRIC),
    TYPE_HOURLYRAIN_PIEZO_MM: ("Ecowitt Hourly Rain Rate Piezo", f"mm/{TIME_HOURS}",
                               TYPE_SENSOR, None, "mdi:water", S_METRIC),
    TYPE_DAILYRAIN_PIEZO_MM: ("Ecowitt Daily Rain Rate Piezo", f"mm/{TIME_DAYS}",
                              TYPE_SENSOR, None, "mdi:water", S_METRIC),
    TYPE_WEEKLYRAIN_PIEZO_MM: ("Ecowitt Weekly Rain Rate Piezo", f"mm/{TIME_WEEKS}",
                               TYPE_SENSOR, None, "mdi:water", S_METRIC),
    TYPE_MONTHLYRAIN_PIEZO_MM: ("Ecowitt Monthly Rain Rate Piezo", f"mm/{TIME_MONTHS}",
                                TYPE_SENSOR, None, "mdi:water", S_METRIC),
    TYPE_YEARLYRAIN_PIEZO_MM: ("Ecowitt Yearly Rain Rate Piezo", f"mm/{TIME_YEARS}",
                               TYPE_SENSOR, None, "mdi:water", S_METRIC),
}
